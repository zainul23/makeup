          ...
          <tr>
            <td class="email-masthead"
              ...
              <a href="https://example.com" class="email-masthead_name"
                style="box-sizing: border-box; color: #bbbfc3; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 20px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                      ...
                      <tr>
                        <td
                          ...
                          <p class="sub"
                            ...
                            align="left">If you’re having trouble with the button above, copy and paste the URL below
                ...
                <tr>
                  <td class="content-cell" align="center"
                    ...
                    <p class="sub align-center"
                      ...
                      align="center">© 2019 American Giant Mattress. All rights reserved.</p>
                    <p class="sub align-center"
                      style="box-sizing: border-box; color: #AEAEAE; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;"
                      align="center">
                      <br />1234 Street Rd.
